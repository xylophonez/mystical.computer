...
raw_default_message() ->
    #{
        ...
        <<"preloaded-devices">> => [
            ...
            #{<<"name">> => <<"arweave-byte-pricing@1.0">>, <<"module">> => dev_arweave_byte_pricing},
            #{<<"name">> => <<"b32-name@1.0">>, <<"module">> => dev_b32_name},
            #{<<"name">> => <<"blacklist@1.0">>, <<"module">> => dev_blacklist},
            #{<<"name">> => <<"bundler-settlement@1.0">>, <<"module">> => dev_bundler_settlement},
            ...
            #{<<"name">> => <<"pricing-router@1.0">>, <<"module">> => dev_pricing_router},
            ...
            #{<<"name">> => <<"service-overlay@1.0">>, <<"module">> => dev_service_overlay},
            #{<<"name">> => <<"simple-pay@1.0">>, <<"module">> => dev_simple_pay},
            #{<<"name">> => <<"simple-oracle@1.0">>, <<"module">> => dev_simple_oracle},
